 ...
 * Generated at: 2022-06-07 07:42:46 UTC
...
/*객체를 하나 만들어보자   */
	...
	pageContext.setAttribute("board",b);
      ...
      out.write("<br> \r\n");
      out.write("	no: ");
      out.print( ((BoardVO)pageContext.getAttribute("board")).getNo );
      out.write("<br> \r\n");
      out.write("	<!--이렇게 해주면 됨 object로 뱉어내므로 형변환을 시켜주자~! BoardVO로 형변환 근데 너무 불편하더라~! -->\r\n");
      out.write("	<!--board로 찾겠다~! 근데 자바빈즈 클래스 형이므로 .no으로 쓰면은 getno을 호출해주더라!   -->\r\n");
      out.write("	no:");
      ...
      out.write("	\r\n");
      out.write("	title :");
      out.print(((BoardVO)pageContext.getAttribute("board")).getTitle() );
      out.write("<br>\r\n");
      out.write("	title : ");
      ...
      out.write("<br>\r\n");
      out.write("	<!--이거 쓰면은 500 에러 발생함 자바빈즈면 getter로 인식 -->\r\n");
      out.write("	aaa:");
